...
@Features({ TestS3BlobStoreDirectUploadAbstract.SetPropertiesFeature.class, AutomationServerFeature.class })
@Deploy("org.nuxeo.ecm.core.storage.binarymanager.s3")
public abstract class TestS3BlobStoreDirectUploadAbstract {
    ...
    public static void setProperties() {
        Map<String, String> properties = TestS3BlobStoreAbstract.getProperties();
        properties.forEach(TestS3BlobStoreAbstract::setProperty);
