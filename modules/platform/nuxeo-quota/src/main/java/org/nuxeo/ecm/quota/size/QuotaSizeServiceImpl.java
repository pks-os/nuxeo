...
public class QuotaSizeServiceImpl extends DefaultComponent implements QuotaSizeService {
    ...
    private Set<String> excludedPathList;

    @Override
    public void start(ComponentContext context) {
        excludedPathList = this.<BlobExcludeDescriptor> getRegistryContributions(XP)
                               .stream()
    ...
    public Collection<String> getExcludedPathList() {
        return Collections.unmodifiableCollection(excludedPathList);
    }
